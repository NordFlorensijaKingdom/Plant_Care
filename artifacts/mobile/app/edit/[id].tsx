...
export default function EditPlantScreen() {
  ...
  if (!plant) {
    return (
      <View style={[styles.center, { backgroundColor: colors.background }]}>
        <Text style={{ color: colors.mutedForeground }}>{t("plant.not_found")}</Text>
      </View>
    );
  }
  ...
  function handlePhotoPress() {
    Alert.alert(t("plantForm.photo.change"), t("plantForm.photo.chooseSource"), [
      { text: t("plantForm.photo.camera"), onPress: takePhoto },
      { text: t("plantForm.photo.library"), onPress: pickPhoto },
      { text: t("plantForm.photo.remove"), style: "destructive", onPress: () => setMainPhoto(null) },
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <Text style={[styles.headerTitle, { color: theme.textColor }]}>{t("plantForm.edit.title")}</Text>
      ...
      >
          ...
          <View style={[styles.photoPicker, { backgroundColor: colors.muted, borderColor: colors.border }]}>
            {mainPhoto ? (
              ...
              <View style={styles.photoPlaceholder}>
                ...
                <Text style={[styles.photoLabel, { color: colors.mutedForeground }]}>{t("plantForm.photo.change")}</Text>
              </View>
            )}
          </View>
        ...
        >
          ...
          <Text style={styles.saveButtonText}>{t("plantForm.edit.cta")}</Text>
        </TouchableOpacity>
      </ScrollView>
    </View>
  );

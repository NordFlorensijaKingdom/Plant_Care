...
export default function EditPlantScreen() {
  ...
  function handlePhotoPress() {
    Alert.alert("Изменить фото", "Выберите источник", [
      ...
      { text: "Удалить фото", style: "destructive", onPress: () => setMainPhoto(null) },
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <Text style={[styles.headerTitle, { color: theme.textColor }]}>Редактировать растение</Text>
          ...
          <View style={[styles.photoPicker, { backgroundColor: colors.muted, borderColor: colors.border }]}>
            {mainPhoto ? (
              ...
              <View style={styles.photoPlaceholder}>
                ...
                <Text style={[styles.photoLabel, { color: colors.mutedForeground }]}>Изменить фото</Text>
              </View>
            )}
          </View>
